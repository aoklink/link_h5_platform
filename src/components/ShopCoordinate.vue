            ...
            >
                ...
                <el-table-column align="left" label="操作">
                    <template slot-scope="scope">
                        ...
                        <router-link class="cc" :to="{ path: '/basecoordinate', query: { inquiry: gymInfoList[scope.$index].name,gym: gymInfoList[scope.$index].gym_name }}">
                                {{ gymInfoList[scope.$index].status==0?'进入坐标设定':'进入坐标设定' }}
                        </router-link>
                    </template>
                </el-table-column>
            </el-table>
