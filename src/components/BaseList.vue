    ...
    <div class="table">
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="bracelet_id" label="健身房名称" width="300"
                />
                <el-table-column prop="user_name" label="手环数量" width="620">
                ...
                <el-table-column class="do" label="操作" width="270" align="center"
                                 prop="status"
                >
                    <template slot-scope="scope">
                        <router-link class="cc" type="text" :to="{ path: '/basebind', query: { inquiry: tableData[scope.$index].bracelet_id }}">
                            {{ '管理' }}
                        </router-link>
                    </template>
                </el-table-column>
...
<style>
    ...
    .el-table tbody .cell, .el-table tbody th div, .el-table--border td:first-child .cell, .el-table--border th:first-child .cell{
