    ...
    <div class="table">
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="bracelet_id" label="编号" width="150"
                                 style="color: red !important"
                />
                <el-table-column prop="user_name" label="手环ID" width="220">
                ...
                <el-table-column prop="phone_num" label="电量" width="230">
                    <template slot-scope="scope">
                        <div type="text">
...
<style scoped>
    ...
    .el-table th:nth-of-type(3) .cell{
        padding-left: 30px;
    }
</style>
